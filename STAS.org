...
** TODO Vista Otros profesionales para clinica [0/5]
- [ ] Tomar template de vista nutri
- [ ] modificar tabla URGENCIA_OTROS_PROFESIONALES [0/3]
  + [ ] Nuevo nombre: HC_OTROS_PROFESIONALES
  + [ ] Campos de UOP a HOP
  + [ ] nueva columna SER_CODIGO char 3
- [ ] Modificar otros profesionales urgencia [0/9]
  + [ ] Vue: Cambiar nombres de propiedades uop -> hop
  + [ ] Vue: Agregar a objeto serCodigo
  + [ ] Api: Agregar a DTO SerCodigo numeric
  + [ ] Api: Cambiar nombres de propiedades Uop -> Hop
  + [ ] SP: Cambiar nombre tabla URGENCIA_OTROS_PROFESIONALES -> HC_OTROS_PROFESIONALES
  + [ ] SP: Campos de UOP a HOP
  + [ ] SP: Agregar al obtener SER_CODIGO
  + [ ] SP: Agregar al guardar SER_CODIGO
  + [ ] Ver opcion de dejar sp globales en lugar de solo para urgencia
