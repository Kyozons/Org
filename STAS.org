...
- API
  - Hospitalizado
    ...
    - CirugiaDTO M
- DB
  - spu_pab_guardar_protocolo_v2 M
...
** TODO Recien Nacido Clinica [0/5]
<2023-07-13 Thu> Inicio
- [ ] Rama feature-recien-nacido desde QA
- [ ] Punto 2 Antecentes maternos Nueva DTO 
- [ ] Punto 3 Antecedentes del parto Nueva DTO
...
- En tabla (por crear) ANTECEDENTES_MATERNOS y ANTECEDENTES_PARTO estan los datos que corresponden a cada parte del formulario respectivamente

- Consulta debido a typos en nombres de tabla / objetos
  - HAP_PUTULENTO -> HAP_PURULENTO
  - HAP_MECONIO_ESPERO -> HAP_MECONIO_ESPESO
  - HAP_PERIODO_ALIM -> HAP_PERIODO_DIL ???

- Al parecer falta dato "cordón umbilical"
