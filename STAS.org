...
- [ ] En Clinica no deja ingresar texto complementario en epicrisis
...
** TODO Requerimiento gestion GES [0/7]
SCHEDULED: <2023-05-22 lun>
- [ ] Agregar en todas los proyectos una vista para gestionar notificaciones GES
- [ ] La vista debe ser una tabla con la lista de pacientes de GES del último mes
- [ ] se debe poder buscar por rut y fecha (tomar ejemplo vista ENO) [0/2]
  - [ ] Rut
  - [ ] Fecha
- [ ] Listado (Vuetable) [0/9]
  - [ ] Rut
  - [ ] Paciente
  - [ ] Ficha
  - [ ] Ingreso
  ...
  - [ ] Medico
  - [ ] Imprimir
- [ ] Ambulatorio feature desde rama master
- [ ] urgencia feature desde QA
- [ ] clinica feature desde QA
