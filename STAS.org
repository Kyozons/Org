...
** TODO requerimiento ficha rehabilitacion [3/8]
SCHEDULED: <2023-03-24 vie>
- [ ] Agregar marca si es primera sesión
- [X] Ocultar motivo consulta
- [X] agregar valor "otro" a escalas
- [ ] agregar campo invisible y required si hay escala seleccionada "resultado escalas evaluadas"
- [ ] al marcar escala mostrar campo "resultado escalas evaluadas"
- [ ] Agregar campos en vue/sp/api/db para resultado escalas evaluadas
  - spu_fca_kine_guardar_sesion_rehabilitacion
  - spu_fca_kine_listar_sesian_rehabilitacion
