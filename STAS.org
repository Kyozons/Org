...
- GIT
  ...
  - API
    - FichaClinicaHospitalizado
      - feature-correcciones-prod-casel (QA) C
** TODO Correcciones Urgencia Produccion CASEL [17/17]
...
- La alternativa que queda es mantener las versiones de los proyectos en la DB, llamar a endpoint en Main.vue de cada proyecto para confirmar que la version actual del proyecto sea la misma que en DB
...
** TODO Test PROD CALAMA Clinica [1/5]
- [ ] En lista de trabajo al hacer doble click te lleva a la atención, pero no completa los datos del paciente
...
- [ ] No se paso el feature de los bagde para indicacion med
- [ ] En Registro Rehabilitacion campo Tiempo desde ultima alimentacion da error al ingresar letras
  - El objeto esta como string en DTO, pero en DB debe ser NUMERIC, por lo tanto se debe restringir a campo numeric en vista
  - además indicar unidad de medida en titulo para ayudar a legibilidad
- [ ] En registro Nutri no se borran todas las evoluciones al seleccionar todo, solo al seleccionar de a una
