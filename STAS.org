...
-[ ] API [3/4]
  ...
  - [X] FichaCliniaAmbulatoria [3/3]
    ...
    - [X] Merge master con gestion-ges
    - [X] Crear rama base master fusionando eno y ges
*** Modificaciones / Correcciones [0/2]
- [ ] Verificar fecha en vuetable ENO, problema formateo
- [-] Cambiar window.open por router.push cuando la ficha sea del mismo proyecto [1/3]
  - [X] Ambulatorio
    - [ ] DEVOLVER ROUTES.JS A LA NORMALIDAD
  - [ ] Urgencia
  - [ ] Clinica

** TODO Implementar informe compilacion en todos los proyectos vue [3/10]
- [X] Ambulatorio [3/3]
