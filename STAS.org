...
** TODO Modificar Required Sol med Urgencia [1/1]
...
** TODO En indicacion medicamento marca conciliacion medicamentosa [7/9]
...
- [ ] En medico agregar marca TRATAMIENTO PERMANENTE como en enfermera
- [ ] En enfermera agregar tooltip en bagde TRATAMIENTO PERMANENTE como en medico
*** Cambios Realizados
- WEB
  - Clinica
...
- GIT
  - feature-alergias-paciente
** TODO Organizar en tabs solicitud de examenes Clinica [6/6]
...
** TODO Organizar en tabs solicitud de examenes Ambulatorio [6/6]
- [X] Orden examenes lab debe ser lista de checkbox sin vuetable
- [X] Orden examenes img debe tener buscar por cada tab con las vuetable
- [X] Si vuetable esta sin datos debe desaparecer
- [X] Orden de tabs examenes lab
...
- GIT
  - feature-examenes-tab
** TODO Organizar en tabs solicitud de examenes Urgencia [0/6]
- [ ] Orden examenes lab debe ser lista de checkbox sin vuetable
- [ ] Orden examenes img debe tener buscar por cada tab con las vuetable
- [ ] Si vuetable esta sin datos debe desaparecer
- [ ] Orden de tabs examenes lab
  1. hematologico
  2. Bioquimico
  3. rto globular
  4. coagulación
  ...
  12. marcadores virales
  13. T.O.R.C.H
- [ ] Orden de tabs examenes Img
  1. rx simple
  2. TAC
  3. Resonancia
  4. rx complejas
  5. ultrasonografia
- [ ] Busqueda General debe estar siempre a la vista [0/2]
  - [ ] Examenes Lab [0/2]
...
- WEB
  - ambulatorio
    - examenes-laboratorio.vue M
    - examenes-imagenologia.vue M
** TODO Favoritos Examenes Clinica [/]
- [ ]
