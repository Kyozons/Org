...
** TODO Requerimiento Epicrisis Enfermeria [5/6]
<2023-05-25 jue>
...
- [-] Realizar API y SP [2/3]
  - [-] En API FichaClinicaHospitalizado crear endponint [3/4]
    - [-] Crear nuevo controller EpicrisisEnfermeriaController [2/3]
      - [X] Crear Endpoint para obtener datos del paciente
      - [X] Crear Endpoint para guardar datos del paciente
      - [ ] Debe haber Endpoint para imprimir
...
** TODO Requerimiento modificaciones GES [0/2]
- [ ] Nuevo filtro con notificados GES y NO notificados GES
