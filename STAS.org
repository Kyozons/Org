...
<2023-07-07 Fri>
- [ ] Agregar lateralidad a protocolo
  - Traer TIT_CODIGO desde pre protocolo y carga protocolo para poder guardar
- [ ] Quitar "_test" de obtener protocolo y obtener_pre_protocolo
  - LAT_CODIGO lo envia como 0, revisar en vue y en api por que, DB está en orden por ahora
*** Cambios Realizados
- WEB
  - Hospitalizado
    - Protocolo M
