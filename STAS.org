...
** TODO Implementar informe compilacion en todos los proyectos vue [9/10]
- [X] Ambulatorio [3/3]
...
- [ ] componentesDistribuidos [0/5] *** PENDIENTE DEBIDO A QUE LAS RUTAS DE EMPAQUETAR.BAT NO SON DEL NOMBRE DEL PROYECTO ***
  - [ ] Crear informeCompilacion.ps1
  - [ ] Modificar empaquetar.bat para llamar informeCompilacion
  - [ ] Push release y master
  - [ ] Variables de entorno VUE_APP_AMBIENTE
  - [ ] RESOLVER DUDA CON COMMIT SIN PUSH EN RELEASE LOCAL
- [X] facturacion [4/4]
  - [X] Crear informeCompilacion.ps1
  - [X] Modificar empaquetar.bat para llamar informeCompilacion
  - [X] Push release y master
