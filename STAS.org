...
- GIT
  feature-correcciones-prod-casel
** TODO Categorizacion ESI Urgencia clasifica mal [1/1]
...
- GIT
  ...
  - API
    - urgencia
      - feature-evolucion-medica
** TODO Imprimir informes en clinica [2/2]
...
** TODO Admision RN con anexo madre Clinica [1/1]
<2023-11-07 Tue>
...
** TODO Evolución Interconsultor en evolucion-medica clinica [10/10]
<2023-11-08 Wed>
...
- GIT
  ...
  - API
    - FichaClinicaHospitalizado
      - feature-evolucion-interconsultor
** TODO Control Enfermeria clinica guardar sólo item [1/2]
...
- [ ] Ventilador Mecánico [0/6]
  - [ ] al momento del click abrir modal agregar objeto e indice [0/1]
    - [ ] modal
  - [ ] en llamada a componente agregar emit hideModalCtrlNeo [0/1]
    - [ ] modal
  - [ ] Al metodo openModalControl, agregar objeto en cuestion e indice como param
  - [ ] En la ref del compontente agregar objeto e indice [0/1]
    - [ ] modal
  - [ ] En parent setear if si modal = a nombremodal y resultado no nulo, asignar valores al objeto del modal correspondiente [0/1]
    - [ ] modal
  - [ ] modal [0/7]
    - [ ] Agregar propiedades al modal para que no cierre con click afuera sólo al cancelar o cerrar
    - [ ] Agregar propiedad en data itemIndex
    - [ ] En el metodo abrirModal agregar objeto e indice como param
    - [ ] Setear el objeto del modal usando los datos del padre que se enviaron como objeto
    - [ ] Comentar emit para obtenerControlEnfermeria
    - [ ] nuevo emit para llamar al metodo hideModal en padre debe recibir resultado e index
    - [ ] En hideModal en caso de cancelar, el mismo emit anterior pero objeto nulo
