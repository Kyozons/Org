...
** TODO Requerimiento Epicrisis Enfermeria [6/6]
<2023-05-25 jue>
...
** TODO Requerimiento modificaciones GES [0/3]
SCHEDULED: <2023-06-13 mar>
- [ ] Nuevo filtro con notificados GES y NO notificados GES [0/2]
  - [ ] Para los no notificados sacar de
  - [ ] si no tiene patologia (no ha sido notificado) no se debe imprimir
- [ ] cambios en medico si/no es seguimiento GES
- [ ] Casos prueba [0/3]
  - [ ] Paciente con diagnostico que no es GES, no debe listarse
  - [ ] Paciente diagnosticado GES, pero no notificado, debe aparecer en filtro no notificado, no se debe imprimir
  - [ ] Paciente diagnosticado GES y notificado, aparecer en lista por defecto y se debe poder imprimir
- [ ] contador de filas
